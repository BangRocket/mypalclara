...
from mindflow.project.wrappers import CrewClass, CrewMetadata
...
if TYPE_CHECKING:
    ...
    from mindflow.project.wrappers import (
        CrewInstance,
        OutputJsonClass,
        OutputPydanticClass,
    )
...
class TaskConfig(TypedDict, total=False):
    ...
    # Misc configuration
    allow_mindflow_trigger_context: bool
...
def get_mcp_tools(self: CrewInstance, *tool_names: str) -> list[BaseTool]:
    ...
    from mindflow_tools import MCPServerAdapter
