...
from mindflow.agent import Agent
from mindflow.agents.agent_builder.base_agent import BaseAgent
from mindflow.agents.cache.cache_handler import CacheHandler
from mindflow.crews.crew_output import CrewOutput
from mindflow.crews.utils import (
    StreamingContext,
...
from mindflow.events.event_listener import EventListener
from mindflow.events.listeners.tracing.trace_listener import (
...
from mindflow.flow.flow_trackable import FlowTrackable
...
from mindflow.memory.entity.entity_memory import EntityMemory
from mindflow.memory.external.external_memory import ExternalMemory
from mindflow.memory.long_term.long_term_memory import LongTermMemory
from mindflow.memory.short_term.short_term_memory import ShortTermMemory
from mindflow.process import Process
from mindflow.rag.embeddings.types import EmbedderConfig
from mindflow.rag.types import SearchResult
...
from mindflow.tasks.conditional_task import ConditionalTask
from mindflow.tasks.task_output import TaskOutput
from mindflow.tools.agent_tools.agent_tools import AgentTools
from mindflow.tools.base_tool import BaseTool
from mindflow.types.streaming import CrewStreamingOutput
from mindflow.types.usage_metrics import UsageMetrics
from mindflow.utilities.constants import NOT_SPECIFIED, TRAINING_DATA_FILE
from mindflow.utilities.crew.models import CrewContext
from mindflow.utilities.evaluators.crew_evaluator_handler import CrewEvaluator
from mindflow.utilities.evaluators.task_evaluator import TaskEvaluator
from mindflow.utilities.file_handler import FileHandler
from mindflow.utilities.formatter import (
    aggregate_raw_outputs_from_task_outputs,
    aggregate_raw_outputs_from_tasks,
)
from mindflow.utilities.i18n import get_i18n
from mindflow.utilities.llm_utils import create_llm
from mindflow.utilities.logger import Logger
from mindflow.utilities.planning_handler import CrewPlanner
from mindflow.utilities.printer import PrinterColor
from mindflow.utilities.rpm_controller import RPMController
from mindflow.utilities.streaming import (
    create_async_chunk_generator,
    create_chunk_generator,
    signal_end,
    signal_error,
)
from mindflow.utilities.task_output_storage_handler import TaskOutputStorageHandler
from mindflow.utilities.training_handler import CrewTrainingHandler
...
class Crew(FlowTrackable, BaseModel):
    ...
    Attributes:
        ...
        share_crew: Whether you want to share the complete crew information and
            execution with MindFlow to make the library better, and allow us to
            train models.
    ...
    def set_private_attrs(self) -> Crew:
        ...
        trace_listener.setup_listeners(mindflow_event_bus)
    ...
    def _set_allow_mindflow_trigger_context_for_first_task(self) -> None:
        mindflow_trigger_payload = self._inputs and self._inputs.get(
            "mindflow_trigger_payload"
        )
        able_to_inject = (
            self.tasks and self.tasks[0].allow_mindflow_trigger_context is None
        )

        if (
            self.process == Process.sequential
            and mindflow_trigger_payload
            and able_to_inject
        ):
            self.tasks[0].allow_mindflow_trigger_context = True

    @staticmethod
    def _show_tracing_disabled_message() -> None:
        """Show a message when tracing is disabled."""
        from mindflow.events.listeners.tracing.utils import has_user_declined_tracing
...
• Set MINDFLOW_TRACING_ENABLED=true in your project's .env file
• Run: mindflow traces enable"""
        else:
            message = """Info: Tracing is disabled.
