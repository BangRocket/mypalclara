"""LangGraph agent adapter for MindFlow integration.

This module contains the LangGraphAgentAdapter class that integrates LangGraph ReAct agents
with MindFlow's agent system. Provides memory persistence, tool integration, and structured
...
from mindflow.agents.agent_adapters.base_agent_adapter import BaseAgentAdapter
from mindflow.agents.agent_adapters.langgraph.langgraph_tool_adapter import (
    LangGraphToolAdapter,
)
from mindflow.agents.agent_adapters.langgraph.protocols import (
    LangGraphCheckPointMemoryModule,
    LangGraphPrebuiltModule,
)
from mindflow.agents.agent_adapters.langgraph.structured_output_converter import (
...
class LangGraphAgentAdapter(BaseAgentAdapter):
    """Adapter for LangGraph agents to work with MindFlow.

    This adapter integrates LangGraph's ReAct agents with MindFlow's agent system,
