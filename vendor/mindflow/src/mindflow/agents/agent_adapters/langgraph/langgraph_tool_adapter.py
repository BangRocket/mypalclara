"""LangGraph tool adapter for MindFlow tool integration.

This module contains the LangGraphToolAdapter class that converts MindFlow tools
...
from mindflow.agents.agent_adapters.base_tool_adapter import BaseToolAdapter
from mindflow.tools.base_tool import BaseTool


class LangGraphToolAdapter(BaseToolAdapter):
    """Adapts MindFlow tools to LangGraph agent tool compatible format.

    Converts MindFlow BaseTool instances to langchain_core.tools format
    ...
    def __init__(self, tools: list[BaseTool] | None = None) -> None:
        ...
        Args:
            tools: Optional list of MindFlow tools to adapt.
        """
        super().__init__()
    ...
    def configure_tools(self, tools: list[BaseTool]) -> None:
        """Configure and convert MindFlow tools to LangGraph-compatible format.

        LangGraph expects tools in langchain_core.tools format. This method
        converts MindFlow BaseTool instances to StructuredTool instances.

        Args:
            tools: List of MindFlow tools to convert.
        """
        ...
        for tool in all_tools:
            ...
            async def tool_wrapper(
                *args: Any, tool: BaseTool = tool, **kwargs: Any
                ...
                """Wrapper function to adapt MindFlow tool calls to LangGraph format.

                Args:
                    *args: Positional arguments for the tool.
                    tool: The MindFlow tool to wrap.
