"""OpenAI agent tool adapter for MindFlow tool integration.

This module contains the OpenAIAgentToolAdapter class that converts MindFlow tools
...
class OpenAIAgentToolAdapter(BaseToolAdapter):
    ...
    Converts MindFlow BaseTool instances to OpenAI Assistant FunctionTool format
    ...
    def configure_tools(self, tools: list[BaseTool]) -> None:
        ...
        Args:
            tools: List of MindFlow tools to configure.
        """
    ...
    def _convert_tools_to_openai_format(
        ...
        """Convert MindFlow tools to OpenAI Assistant tool format.
        ...
        def create_tool_wrapper(tool: BaseTool) -> Any:
            ...
            async def wrapper(context_wrapper: Any, arguments: Any) -> Any:
                """Wrapper function to adapt MindFlow tool calls to OpenAI format.
