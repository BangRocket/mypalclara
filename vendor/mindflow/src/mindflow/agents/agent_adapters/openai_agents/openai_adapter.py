"""OpenAI agents adapter for MindFlow integration.

This module contains the OpenAIAgentAdapter class that integrates OpenAI Assistants
with MindFlow's agent system, providing tool integration and structured output support.
"""
...
from mindflow.agents.agent_adapters.openai_agents.openai_agent_tool_adapter import (
    OpenAIAgentToolAdapter,
)
from mindflow.agents.agent_adapters.openai_agents.protocols import (
    AgentKwargs,
    OpenAIAgent as OpenAIAgentProtocol,
    OpenAIAgentsModule,
)
from mindflow.agents.agent_adapters.openai_agents.structured_output_converter import (
...
class OpenAIAgentAdapter(BaseAgentAdapter):
    ...
    Integrates OpenAI Assistants API with MindFlow's agent system, providing
