"""OpenAI structured output converter for MindFlow task integration.
...
from mindflow.agents.agent_adapters.base_converter_adapter import BaseConverterAdapter
