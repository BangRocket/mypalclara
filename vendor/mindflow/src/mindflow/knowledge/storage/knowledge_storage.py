...
from mindflow.knowledge.storage.base_knowledge_storage import BaseKnowledgeStorage
from mindflow.rag.chromadb.config import ChromaDBConfig
from mindflow.rag.chromadb.types import ChromaEmbeddingFunctionWrapper
from mindflow.rag.config.utils import get_rag_client
...
from mindflow.rag.embeddings.types import ProviderSpec
from mindflow.rag.factory import create_client
from mindflow.rag.types import BaseRecord, SearchResult
        ...
        try:
            ...
            if "dimension mismatch" in str(e).lower():
                Logger(verbose=True).log(
                    "error",
                    "Embedding dimension mismatch. This usually happens when mixing different embedding models. Try resetting the collection using `mindflow reset-memories -a`",
                    "red",
                )
                raise ValueError(
                    "Embedding dimension mismatch. Make sure you're using the same embedding model "
                    "across all operations with this collection."
                    "Try resetting the collection using `mindflow reset-memories -a`"
                ) from e
