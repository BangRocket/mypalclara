...
from mindflow.a2a.extensions.base import ExtensionRegistry
from mindflow.a2a.task_helpers import TaskStateResult
from mindflow.a2a.templates import (
...
from mindflow.a2a.types import AgentResponseProtocol
from mindflow.a2a.utils import (
...
def _handle_agent_response_and_continue(
    ...
    """Handle A2A result and get MindFlow agent's response.
...
def _delegate_to_a2a(
    ...
    try:
        for turn_num in range(max_turns):
            console_formatter = getattr(mindflow_event_bus, "_console", None)
            agent_branch = None
