...
from mindflow.a2a.auth.schemas import APIKeyAuth, HTTPDigestAuth
from mindflow.a2a.auth.utils import (
    _auth_store,
...
from mindflow.a2a.types import (
    HANDLER_REGISTRY,
    HandlerType,
    PartsDict,
    PartsMetadataDict,
)
from mindflow.a2a.updates import (
    PollingConfig,
...
from mindflow.types.utils import create_literals_from_strings


if TYPE_CHECKING:
    from a2a.types import Message

    from mindflow.a2a.auth.schemas import AuthScheme
...
def execute_a2a_delegation(
    ...
    Args:
        ...
        agent_role: Role of the MindFlow agent delegating the task.
