...
This module provides configuration for MindFlow security features, including:
- Authentication settings
- Scoping rules
- Fingerprinting

The SecurityConfig class is the primary interface for managing security settings
in MindFlow applications.
"""
...
class SecurityConfig(BaseModel):
    """
    Configuration for MindFlow security features.

    This class manages security settings for MindFlow agents, including:
