...
try:
    ...
    raise ImportError(
        'Azure AI Inference native provider not available, to install: uv add "mindflow[azure-ai-inference]"'
    ) from None
...
class AzureCompletion(BaseLLM):
    ...
    def _convert_tools_for_interference(  # type: ignore[override]
        ...
        """Convert MindFlow tool format to Azure OpenAI function calling format.

        Args:
            tools: List of MindFlow tool definitions
