...
try:
    ...
    raise ImportError(
        'AWS Bedrock native provider not available, to install: uv add "mindflow[bedrock]"'
    ) from None
...
class BedrockCompletion(BaseLLM):
    ...
    async def acall(
        ...
        if not AIOBOTOCORE_AVAILABLE:
            raise NotImplementedError(
                ...
                'Install with: uv add "mindflow[bedrock-async]"'
            )
    ...
    def _format_tools_for_converse(
        ...
        """Convert MindFlow tools to Converse API format following AWS specification."""
