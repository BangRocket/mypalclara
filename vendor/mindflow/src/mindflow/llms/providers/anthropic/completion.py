...
try:
    ...
    raise ImportError(
        'Anthropic native provider not available, to install: uv add "mindflow[anthropic]"'
    ) from None
...
class AnthropicCompletion(BaseLLM):
    ...
    def _convert_tools_for_interference(
        ...
        """Convert MindFlow tool format to Anthropic tool use format."""
        anthropic_tools = []
    ...
    def get_context_window_size(self) -> int:
        ...
        from mindflow.llm import CONTEXT_WINDOW_USAGE_RATIO
