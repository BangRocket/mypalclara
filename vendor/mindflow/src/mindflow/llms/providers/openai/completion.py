...
from mindflow.events.types.llm_events import LLMCallType
from mindflow.llms.base_llm import BaseLLM
from mindflow.llms.hooks.transport import AsyncHTTPTransport, HTTPTransport
from mindflow.utilities.agent_utils import is_context_length_exceeded
from mindflow.utilities.exceptions.context_window_exceeding_exception import (
    LLMContextLengthExceededError,
)
from mindflow.utilities.pydantic_schema_utils import generate_model_description
from mindflow.utilities.types import LLMMessage


if TYPE_CHECKING:
    from mindflow.agent.core import Agent
    from mindflow.llms.hooks.base import BaseInterceptor
...
class OpenAICompletion(BaseLLM):
    ...
    def _prepare_completion_params(
        ...
        # Filter out MindFlow-specific parameters that shouldn't go to the API
        mindflow_specific_params = {
            "callbacks",
            "available_functions",
            "from_task",
            "from_agent",
        ...
        return {k: v for k, v in params.items() if k not in mindflow_specific_params}

    def _convert_tools_for_interference(
        self, tools: list[dict[str, BaseTool]]
    ) -> list[dict[str, Any]]:
        """Convert MindFlow tool format to OpenAI function calling format."""
        from mindflow.llms.providers.utils.common import safe_tool_conversion
    ...
    def get_context_window_size(self) -> int:
        ...
        from mindflow.llm import CONTEXT_WINDOW_USAGE_RATIO, LLM_CONTEXT_WINDOW_SIZES
