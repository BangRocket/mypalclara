...
from mindflow.cli.authentication.token import AuthError, get_auth_token
...
from mindflow.events.listeners.tracing.trace_batch_manager import TraceBatchManager
...
from mindflow.events.types.system_events import SignalEvent, on_signal
...
class TraceCollectionListener(BaseEventListener):
    ...
    def _get_user_context(self) -> dict[str, str]:
        ...
        return {
            "user_id": os.getenv("MINDFLOW_USER_ID") or os.getenv("CREWAI_USER_ID", "anonymous"),
            "organization_id": os.getenv("MINDFLOW_ORG_ID") or os.getenv("CREWAI_ORG_ID", ""),
    ...
    def setup_listeners(self, mindflow_event_bus: MindflowEventsBus) -> None:
        ...
        self._register_flow_event_handlers(mindflow_event_bus)
        self._register_context_event_handlers(mindflow_event_bus)
        self._register_action_event_handlers(mindflow_event_bus)
        self._register_system_event_handlers(mindflow_event_bus)

        self._listeners_setup = True

    def _register_flow_event_handlers(self, event_bus: MindflowEventsBus) -> None:
    ...
    def _register_context_event_handlers(self, event_bus: MindflowEventsBus) -> None:
    ...
    def _register_action_event_handlers(self, event_bus: MindflowEventsBus) -> None:
    ...
    def _register_system_event_handlers(self, event_bus: MindflowEventsBus) -> None:
    ...
    def _initialize_crew_batch(self, source: Any, event: Any) -> None:
        ...
        execution_metadata = {
            ...
            "mindflow_version": get_mindflow_version(),
        }
