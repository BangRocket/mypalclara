...
from mindflow.utilities.paths import db_storage_path
from mindflow.utilities.serialization import to_serializable
...
def should_enable_tracing(*, override: bool | None = None) -> bool:
    ...
    2. Environment variable MINDFLOW_TRACING_ENABLED
    ...
    env_value = (os.getenv("MINDFLOW_TRACING_ENABLED") or os.getenv("CREWAI_TRACING_ENABLED", "")).lower()
...
def _user_data_file() -> Path:
    ...
    return base / ".mindflow_user.json"
...
def is_tracing_enabled() -> bool:
    ...
    return (os.getenv("MINDFLOW_TRACING_ENABLED") or os.getenv("CREWAI_TRACING_ENABLED", "false")).lower() == "true"
...
def on_first_execution_tracing_confirmation() -> bool:
    ...
    if is_first_execution():
        ...
        return click.confirm(
            "This is the first execution of MindFlow. Do you want to enable tracing?",
            default=True,
            show_default=True,
        )
    return False
...
def _is_test_environment() -> bool:
    ...
    return (os.environ.get("MINDFLOW_TESTING") or os.environ.get("CREWAI_TESTING", "")).lower() == "true"
