...
from mindflow.rag.core.base_embeddings_callable import EmbeddingFunction
from mindflow.rag.core.base_embeddings_provider import BaseEmbeddingsProvider
from mindflow.utilities.import_utils import import_and_validate_definition
...
if TYPE_CHECKING:
    ...
    from mindflow.rag.embeddings.providers.ibm.embedding_callable import (
    ...
    from mindflow.rag.embeddings.providers.voyageai.embedding_callable import (
...
PROVIDER_PATHS = {
    "azure": "mindflow.rag.embeddings.providers.microsoft.azure.AzureProvider",
    "amazon-bedrock": "mindflow.rag.embeddings.providers.aws.bedrock.BedrockProvider",
    "cohere": "mindflow.rag.embeddings.providers.cohere.cohere_provider.CohereProvider",
    "custom": "mindflow.rag.embeddings.providers.custom.custom_provider.CustomProvider",
    "google-generativeai": "mindflow.rag.embeddings.providers.google.generative_ai.GenerativeAiProvider",
    "google": "mindflow.rag.embeddings.providers.google.generative_ai.GenerativeAiProvider",
    "google-vertex": "mindflow.rag.embeddings.providers.google.vertex.VertexAIProvider",
    "huggingface": "mindflow.rag.embeddings.providers.huggingface.huggingface_provider.HuggingFaceProvider",
    "instructor": "mindflow.rag.embeddings.providers.instructor.instructor_provider.InstructorProvider",
    "jina": "mindflow.rag.embeddings.providers.jina.jina_provider.JinaProvider",
    "ollama": "mindflow.rag.embeddings.providers.ollama.ollama_provider.OllamaProvider",
    "onnx": "mindflow.rag.embeddings.providers.onnx.onnx_provider.ONNXProvider",
    "openai": "mindflow.rag.embeddings.providers.openai.openai_provider.OpenAIProvider",
    "openclip": "mindflow.rag.embeddings.providers.openclip.openclip_provider.OpenCLIPProvider",
    "roboflow": "mindflow.rag.embeddings.providers.roboflow.roboflow_provider.RoboflowProvider",
    "sentence-transformer": "mindflow.rag.embeddings.providers.sentence_transformer.sentence_transformer_provider.SentenceTransformerProvider",
    "text2vec": "mindflow.rag.embeddings.providers.text2vec.text2vec_provider.Text2VecProvider",
    "voyageai": "mindflow.rag.embeddings.providers.voyageai.voyageai_provider.VoyageAIProvider",
    "watsonx": "mindflow.rag.embeddings.providers.ibm.watsonx.WatsonXProvider",
}
