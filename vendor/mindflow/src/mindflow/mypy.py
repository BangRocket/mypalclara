"""Mypy plugin for MindFlow decorator type checking.
...
class MindflowPlugin(Plugin):
    ...
    def get_class_decorator_hook(
        ...
        """
        if fullname in ("mindflow.project.CrewBase", "mindflow.project.crew_base.CrewBase"):
