...
{{folder_name}} is a MindFlow Tool. This template is designed to help you create
...
```bash
mindflow tool publish {{tool_name}}
```

Others may install your tool in their crews running:

```bash
mindflow tool install {{tool_name}}
```

## Support

For support, questions, or feedback regarding the {{crew_name}} tool or MindFlow.
