...
from mindflow.cli.constants import DEFAULT_MINDFLOW_CLOUD_URL
from mindflow.cli.version import get_mindflow_version


class PlusAPI:
    """
    This class exposes methods for working with the MindFlow Cloud API.
    """

    # API v1 endpoints
    TOOLS_RESOURCE = "/api/v1/tools"
    ORGANIZATIONS_RESOURCE = "/api/v1/me/organizations"
    CREWS_RESOURCE = "/api/v1/crews"
    AGENTS_RESOURCE = "/api/v1/agents"
    TRACING_RESOURCE = "/api/v1/tracing"
    EPHEMERAL_TRACING_RESOURCE = "/api/v1/tracing/ephemeral"
    INTEGRATIONS_RESOURCE = "/api/v1/integrations"
    ...
    def __init__(self, api_key: str) -> None:
        ...
        self.headers = {
            ...
            "User-Agent": f"MindFlow-CLI/{get_mindflow_version()}",
            "X-MindFlow-Version": get_mindflow_version(),
        }
        settings = Settings()
        if settings.org_uuid:
            self.headers["X-MindFlow-Organization-Id"] = settings.org_uuid

        self.base_url = os.getenv("MINDFLOW_CLOUD_URL") or str(settings.enterprise_base_url) or DEFAULT_MINDFLOW_CLOUD_URL
