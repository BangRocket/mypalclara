# MindFlow Cloud - self-hosted backend
DEFAULT_MINDFLOW_CLOUD_URL = "https://mindflow.jorsh.app"

# MindFlow Cloud OAuth2 settings
MINDFLOW_CLOUD_OAUTH2_PROVIDER = "jwt"  # We use simple JWT auth
MINDFLOW_CLOUD_OAUTH2_AUDIENCE = ""
MINDFLOW_CLOUD_OAUTH2_CLIENT_ID = ""
MINDFLOW_CLOUD_OAUTH2_DOMAIN = "mindflow.jorsh.app"

# Legacy aliases for compatibility
DEFAULT_MINDFLOW_CLOUD_URL = DEFAULT_MINDFLOW_CLOUD_URL
MINDFLOW_CLOUD_OAUTH2_PROVIDER = MINDFLOW_CLOUD_OAUTH2_PROVIDER
MINDFLOW_CLOUD_OAUTH2_AUDIENCE = MINDFLOW_CLOUD_OAUTH2_AUDIENCE
MINDFLOW_CLOUD_OAUTH2_CLIENT_ID = MINDFLOW_CLOUD_OAUTH2_CLIENT_ID
MINDFLOW_CLOUD_OAUTH2_DOMAIN = MINDFLOW_CLOUD_OAUTH2_DOMAIN
