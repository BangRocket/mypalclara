...
from mindflow.cli.constants import ENV_VARS
from mindflow.crew import Crew
from mindflow.flow import Flow
...
def _get_project_attribute(
    ...
    try:
        ...
        if not any(True for dep in dependencies if "mindflow" in dep):
            raise Exception("mindflow is not in the dependencies.")
...
def is_valid_tool(obj: Any) -> bool:
    from mindflow.tools.base_tool import Tool
...
def _print_no_tools_warning() -> None:
    ...
    console.print(
        ...
        "[green]from mindflow.tools import BaseTool, tool\n\n"
        "# Tool class example\n"
