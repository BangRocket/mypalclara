...
from mindflow.cli.authentication.utils import validate_jwt_token
...
if TYPE_CHECKING:
    from mindflow.cli.authentication.providers.base_provider import BaseProvider
...
class ProviderFactory:
    ...
    def from_settings(
        ...
        module = importlib.import_module(
            f"mindflow.cli.authentication.providers.{settings.provider.lower()}"
        )
...
class AuthenticationCommand:
    ...
    def login(self) -> None:
        """Sign up to MindFlow+"""
        console.print("Signing in to MindFlow Cloud...\n", style="bold blue")
