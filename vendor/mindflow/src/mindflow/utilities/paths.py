"""Path management utilities for MindFlow storage and configuration."""
...
def get_project_directory_name() -> str:
    ...
    return os.environ.get("MINDFLOW_STORAGE_DIR") or os.environ.get("CREWAI_STORAGE_DIR", Path.cwd().name)
