"""JSON encoder for handling MindFlow specific types."""
...
class CrewJSONEncoder(json.JSONEncoder):
    """Custom JSON encoder for MindFlow objects and special types."""

    def default(self, obj: Any) -> Any:
        """Custom serialization for MindFlow specific types.
