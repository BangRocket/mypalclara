...
def enable_telemetry_for_tests():
    ...
    original_telemetry = os.environ.get("MINDFLOW_DISABLE_TELEMETRY")
    original_otel = os.environ.get("OTEL_SDK_DISABLED")

    os.environ["MINDFLOW_DISABLE_TELEMETRY"] = "false"
    os.environ["OTEL_SDK_DISABLED"] = "false"

    with mindflow_event_bus._rwlock.w_locked():
        mindflow_event_bus._sync_handlers.clear()
        mindflow_event_bus._async_handlers.clear()
    ...
    if original_telemetry is not None:
        os.environ["MINDFLOW_DISABLE_TELEMETRY"] = original_telemetry
    else:
        os.environ.pop("MINDFLOW_DISABLE_TELEMETRY", None)
