...
def test_anthropic_completion_module_is_imported():
    ...
    """
    module_name = "mindflow.llms.providers.anthropic.completion"
...
def test_native_anthropic_raises_error_when_initialization_fails():
    ...
    with patch('mindflow.llm.LLM._get_native_provider') as mock_get_provider:
...
def test_anthropic_raises_error_when_model_not_supported():
    ...
    with patch('mindflow.llms.providers.anthropic.completion.Anthropic') as mock_anthropic_class:
...
def test_anthropic_tool_conversion():
    ...
    anthropic_tools = llm._convert_tools_for_interference(mindflow_tools)
