...
def test_gemini_completion_module_is_imported():
    ...
    """
    module_name = "mindflow.llms.providers.gemini.completion"
...
def test_gemini_raises_error_when_model_not_supported():
    ...
    with patch('mindflow.llms.providers.gemini.completion.genai') as mock_genai:
...
def test_gemini_tool_conversion():
    ...
    gemini_tools = llm._convert_tools_for_interference(mindflow_tools)
