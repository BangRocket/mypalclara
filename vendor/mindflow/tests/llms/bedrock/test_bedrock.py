...
def mock_aws_credentials():
    ...
    with patch.dict(os.environ, {
        ...
        with patch('mindflow.llms.providers.bedrock.completion.Session') as mock_session_class:
...
def test_bedrock_completion_module_is_imported():
    ...
    """
    module_name = "mindflow.llms.providers.bedrock.completion"
...
def test_bedrock_tool_conversion():
    ...
    bedrock_tools = llm._format_tools_for_converse(mindflow_tools)
