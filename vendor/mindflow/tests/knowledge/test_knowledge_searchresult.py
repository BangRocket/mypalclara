...
import pytest
from mindflow.knowledge.knowledge import Knowledge  # type: ignore[import-untyped]
from mindflow.knowledge.source.string_knowledge_source import (  # type: ignore[import-untyped]
    StringKnowledgeSource,
)
from mindflow.knowledge.utils.knowledge_utils import (  # type: ignore[import-untyped]
...
def test_knowledge_query_returns_searchresult() -> None:
    ...
    with patch("mindflow.knowledge.knowledge.KnowledgeStorage") as mock_storage_class:
...
@patch("mindflow.rag.config.utils.get_rag_client")
@patch("mindflow.knowledge.storage.knowledge_storage.KnowledgeStorage")
