...
from mindflow.rag.embeddings.factory import build_embedder, PROVIDER_PATHS
from mindflow.rag.embeddings.providers.openai.openai_provider import OpenAIProvider
from mindflow.rag.embeddings.providers.cohere.cohere_provider import CohereProvider
from mindflow.rag.embeddings.providers.google.generative_ai import GenerativeAiProvider
from mindflow.rag.embeddings.providers.google.vertex import VertexAIProvider
from mindflow.rag.embeddings.providers.microsoft.azure import AzureProvider
from mindflow.rag.embeddings.providers.jina.jina_provider import JinaProvider
from mindflow.rag.embeddings.providers.ollama.ollama_provider import OllamaProvider
from mindflow.rag.embeddings.providers.aws.bedrock import BedrockProvider
from mindflow.rag.embeddings.providers.text2vec.text2vec_provider import Text2VecProvider
from mindflow.rag.embeddings.providers.sentence_transformer.sentence_transformer_provider import (
    SentenceTransformerProvider,
)
from mindflow.rag.embeddings.providers.instructor.instructor_provider import InstructorProvider
from mindflow.rag.embeddings.providers.openclip.openclip_provider import OpenCLIPProvider
...
class TestFactoryBackwardCompatibility:
    ...
    def test_factory_with_google_alias(self):
        ...
        with patch("mindflow.rag.embeddings.factory.import_and_validate_definition") as mock_import:
            ...
            mock_import.assert_called_once_with(
                "mindflow.rag.embeddings.providers.google.generative_ai.GenerativeAiProvider"
            )
