...
from mindflow.experimental.evaluation.agent_evaluator import AgentEvaluator
...
class TestAgentEvaluator:
    ...
    def test_evaluate_current_iteration(self, mock_crew):
        with mindflow_event_bus.scoped_handlers():
            ...
            @mindflow_event_bus.on(AgentEvaluationCompletedEvent)
    ...
    def test_eval_specific_agents_from_crew(self, mock_crew):
        with mindflow_event_bus.scoped_handlers():
            ...
            @mindflow_event_bus.on(AgentEvaluationStartedEvent)
            ...
            @mindflow_event_bus.on(AgentEvaluationFailedEvent)
