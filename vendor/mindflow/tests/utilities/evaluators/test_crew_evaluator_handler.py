...
from mindflow.utilities.evaluators.crew_evaluator_handler import (
    CrewEvaluator,
...
class InternalCrewEvaluator:
    ...
    @mock.patch("mindflow.utilities.evaluators.crew_evaluator_handler.Console")
    @mock.patch("mindflow.utilities.evaluators.crew_evaluator_handler.Table")
