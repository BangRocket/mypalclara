...
from mindflow.utilities.evaluators.task_evaluator import (
    TaskEvaluator,
    TrainingTaskEvaluation,
)


@patch("mindflow.utilities.evaluators.task_evaluator.TrainingConverter")
...
@patch("mindflow.utilities.converter.Converter.to_pydantic")
@patch("mindflow.utilities.training_converter.TrainingConverter._convert_field_by_field")
