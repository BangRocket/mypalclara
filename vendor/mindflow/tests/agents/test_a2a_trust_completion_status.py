...
def test_trust_remote_completion_status_true_returns_directly():
    ...
    from mindflow.a2a.wrapper import _delegate_to_a2a
    from mindflow.a2a.types import AgentResponseProtocol
    from mindflow import Agent, Task
    ...
    with (
        patch("mindflow.a2a.wrapper.execute_a2a_delegation") as mock_execute,
        patch("mindflow.a2a.wrapper._fetch_agent_cards_concurrently") as mock_fetch,
    ):
        mock_card = MagicMock()
        mock_card.name = "Test"
