...
class TestAsyncAgentExecutor:
    ...
    async def test_ainvoke_loop_calls_aget_llm_response(
        ...
        with patch(
            "mindflow.agents.crew_agent_executor.aget_llm_response",
            new_callable=AsyncMock,
    ...
    async def test_ainvoke_loop_handles_tool_execution(
        ...
        with patch(
            ...
            with patch(
                "mindflow.agents.crew_agent_executor.aexecute_tool_and_check_finality",
                new_callable=AsyncMock,
    ...
    async def test_ainvoke_loop_respects_max_iterations(
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    "mindflow.agents.crew_agent_executor.handle_max_iterations_exceeded",
                    return_value=AgentFinish(
...
class TestAsyncLLMResponseHelper:
    ...
    async def test_aget_llm_response_calls_acall(self) -> None:
        ...
        from mindflow.utilities.agent_utils import aget_llm_response
