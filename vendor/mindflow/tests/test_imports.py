...
def test_task_output_import():
    """Test that TaskOutput can be imported from mindflow."""
    from mindflow import TaskOutput

    assert TaskOutput is not None


def test_crew_output_import():
    """Test that CrewOutput can be imported from mindflow."""
    from mindflow import CrewOutput
