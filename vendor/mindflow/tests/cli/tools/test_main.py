...
@patch("mindflow.cli.tools.main.subprocess.run")
...
@patch("mindflow.cli.tools.main.subprocess.run")
@patch("mindflow.cli.plus_api.PlusAPI.get_tool")
@patch("mindflow.cli.tools.main.ToolCommand._print_current_organization")
...
@patch("mindflow.cli.tools.main.git.Repository.is_synced", return_value=False)
...
@patch("mindflow.cli.tools.main.get_project_name", return_value="sample-tool")
@patch("mindflow.cli.tools.main.get_project_version", return_value="1.0.0")
@patch("mindflow.cli.tools.main.get_project_description", return_value="A sample tool")
@patch("mindflow.cli.tools.main.subprocess.run")
@patch("mindflow.cli.tools.main.os.listdir", return_value=["sample-tool-1.0.0.tar.gz"])
@patch(
    "mindflow.cli.tools.main.open",
    new_callable=unittest.mock.mock_open,
    read_data=b"sample tarball content",
)
@patch("mindflow.cli.plus_api.PlusAPI.publish_tool")
@patch("mindflow.cli.tools.main.git.Repository.is_synced", return_value=False)
@patch(
    "mindflow.cli.tools.main.extract_available_exports",
...
@patch("mindflow.cli.plus_api.PlusAPI.publish_tool")
@patch("mindflow.cli.tools.main.git.Repository.is_synced", return_value=True)
@patch(
    "mindflow.cli.tools.main.extract_available_exports",
    return_value=[{"name": "SampleTool"}],
)
...
@patch("mindflow.cli.tools.main.Settings")
