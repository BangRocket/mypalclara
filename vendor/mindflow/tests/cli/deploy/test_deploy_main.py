...
from mindflow.cli.utils import parse_toml
from requests.exceptions import JSONDecodeError


class TestDeployCommand(unittest.TestCase):
    @patch("mindflow.cli.command.get_auth_token")
    @patch("mindflow.cli.deploy.main.get_project_name")
    @patch("mindflow.cli.command.PlusAPI")
    ...
    @patch("mindflow.cli.deploy.main.DeployCommand._display_deployment_info")
    ...
    @patch("mindflow.cli.deploy.main.fetch_and_json_env_file")
    @patch("mindflow.cli.deploy.main.git.Repository.origin_url")
    ...
    def test_parse_toml_python_311_plus(self):
        ...
        python = "^3.11"
        mindflow = { extras = ["tools"], version = ">=0.51.0,<1.0.0" }
        """
    ...
    def test_get_project_name_python_310(self, mock_open):
        from mindflow.cli.utils import get_project_name
    ...
    def test_get_mindflow_version(self):
        from mindflow.cli.version import get_mindflow_version

        assert isinstance(get_mindflow_version(), str)
