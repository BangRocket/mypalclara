...
from mindflow.cli.create_crew import create_crew, create_folder_structure
...
@mock.patch("mindflow.cli.create_crew.copy_template")
@mock.patch("mindflow.cli.create_crew.write_env_file")
@mock.patch("mindflow.cli.create_crew.load_env_vars")
def test_create_crew_with_trailing_slash_creates_valid_project(
    ...
    with tempfile.TemporaryDirectory() as work_dir:
        with mock.patch(
            "mindflow.cli.create_crew.create_folder_structure"
...
@mock.patch("mindflow.cli.create_crew.create_folder_structure")
@mock.patch("mindflow.cli.create_crew.copy_template")
@mock.patch("mindflow.cli.create_crew.load_env_vars")
@mock.patch("mindflow.cli.create_crew.get_provider_data")
@mock.patch("mindflow.cli.create_crew.select_provider")
@mock.patch("mindflow.cli.create_crew.select_model")
