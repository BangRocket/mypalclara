...
class TestEnterpriseConfigureCommand(unittest.TestCase):
    def setUp(self):
        ...
        with patch('mindflow.cli.enterprise.main.SettingsCommand') as mock_settings_command_class:
    ...
    @patch('mindflow.cli.enterprise.main.requests.get')
    @patch('mindflow.cli.enterprise.main.get_mindflow_version')
    def test_successful_configuration(self, mock_get_version, mock_requests_get):
        ...
        expected_headers = {
            ...
            "User-Agent": "MindFlow-CLI/1.0.0",
            "X-Mindflow-Version": "1.0.0",
        }
