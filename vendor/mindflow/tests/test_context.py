...
class TestPlatformIntegrationToken:
    ...
    @patch.dict(os.environ, {"MINDFLOW_PLATFORM_INTEGRATION_TOKEN": "env-token-456"})
    ...
    @patch.dict(os.environ, {"MINDFLOW_PLATFORM_INTEGRATION_TOKEN": "env-token"})
    ...
    @patch.dict(os.environ, {"MINDFLOW_PLATFORM_INTEGRATION_TOKEN": "env-backup"})
    ...
    @patch.dict(os.environ, {"MINDFLOW_PLATFORM_INTEGRATION_TOKEN": ""})
    def test_empty_env_var(self):
        assert _platform_integration_token.get() is None
        assert get_platform_integration_token() == ""

    @patch("mindflow.context.os.getenv")
