"""FalkorDB graph store implementation for vendored mem0."""
...
class MemoryGraph:
    ...
    def _establish_nodes_relations_from_data(self, data, filters, entity_type_map):
        ...
        extracted_entities = self.llm.generate_response(messages=messages, tools=_tools)
    ...
    def _search_source_node(self, source_embedding, filters):
    ...
    def _search_destination_node(self, dest_embedding, filters):
