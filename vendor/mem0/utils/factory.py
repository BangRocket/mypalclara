...
class LlmFactory:
    ...
    provider_to_class = {
        ...
        "azure_openai_structured": (
            "vendor.mem0.llms.azure_openai_structured.AzureOpenAIStructuredLLM",
            AzureOpenAIConfig,
        ),
...
class GraphStoreFactory:
    ...
    provider_to_class = {
        ...
        "falkordb": "vendor.mem0.memory.falkordb_memory.MemoryGraph",
...
class RerankerFactory:
    ...
    provider_to_class = {
        ...
        "sentence_transformer": (
            "vendor.mem0.reranker.sentence_transformer_reranker.SentenceTransformerReranker",
