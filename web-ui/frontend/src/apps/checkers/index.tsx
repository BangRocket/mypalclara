/**
 * Checkers app wrapper.
 *
 * The underlying Checkers page component requires a `game` prop that was
 ...
 */
export default function CheckersApp({ windowId: _windowId }: { windowId: string }) {
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 p-8 text-center">
      <span className="text-5xl">{'\u265F\uFE0F'}</span>
      <h2 className="text-lg font-semibold">Checkers</h2>
      <p className="max-w-sm text-sm text-muted-foreground">
        Start a new Checkers game from the <strong>Games</strong> lobby, or
