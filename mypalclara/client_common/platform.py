"""Platform abstraction layer for Clara (client-side copy).

Defines common interfaces for different communication platforms (Discord, API, Slack, etc.).
Vendored from `mypalclara.core.platform` (minus the engine-only APIAdapter) so adapters
carry no engine import. Keep stdlib-only.
"""
